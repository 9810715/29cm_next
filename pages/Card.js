...
const Card = ({
  ...
  // props 로 바뀌는 데이터는 App.js 에서 설정하도록 하기
  <div className="out_box">
    {/* next.js 에서는 a 태그 말고 Link 태그 사용 권장 */}
    ...
    <div className="text_content">
      ...
      <div className="text_center">
        ...
        {/* a && b && c */}
        {/* a가 거짓 -> a를 반환 */}
        {/* a가 참이고 b가 거짓이면 -> b를 반환 */}
        {/* a,b 가 모두 참이면 -> c를 반환(jsx를 렌더링!) */}
...
// 구조분해할당을 사용해서 매개변수 부분이 길어지더라도, 구조 분해할당이 주는 장점이 더 많음
// 1. 코드 가독성 향상(반복되는 props 참조를 줄임)
// 2. 편리한 유지보수(props 를 추가하거나 수정할때 코드변경 편리)

export default Card;
// -> 카드는 컴포넌트 자체를 내보내는 코드로 함수 호출형태가 아님
